...
(function ($) {
    ...
    // 获取行数据 updated by huanghao on 2017/10/24 13:30
    var getRowData = function (editableForm) {
        var tr = editableForm.$div.closest('tr');
        var table = editableForm.$div.closest('table');
    ...
    EditableForm.prototype = {
        ...
        **/        
        ...
        submit: function(e) {
            ...
            //  updated by huanghao on 2017/10/24 12:09
            var rowData = getRowData(this);
            var error = this.validate(newValue, rowData);
        ...
        validate: function (value, rowData) {
            ...
            if (typeof this.options.validate === 'function') {
                return this.options.validate.call(this.options.scope, value, rowData);
            }
        },
