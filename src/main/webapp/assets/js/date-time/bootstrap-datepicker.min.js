...
function(d) {
    ...
    a.prototype = {
        ...
        fill: function() {
            ...
            this.picker.find("tfoot th.clear").text(e[this.language].clear).toggle(this.clearBtn !== false);
            this.updateNavArrows();
            this.fillMonths();
    ...
    var c = {
        ...
        footTemplate: '<tfoot><tr><th colspan="3" class="today"></th><th colspan="4" class="clear"></th></tr></tfoot>'
    };
